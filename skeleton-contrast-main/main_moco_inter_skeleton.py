...
parser.add_argument('--pre-dataset', default='ntu120', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #
    train_sampler = None
    # sampler and shuffle can not be true at the same time
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 50 == 0:
                  ...
                  }, is_best=False, filename=args.checkpoint_path+'/checkpoint_test120_{:04d}.pth.tar'.format(epoch))
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filename, 'model_best_val_120.pth.tar')
