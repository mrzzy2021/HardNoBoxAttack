...
parser.add_argument('--pre-dataset', default='hdm05', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 10 == 0 and epoch >= 400:
                  ...
                  }, is_best=False, filename=args.checkpoint_path+'/checkpoint_{:04d}_hdm05full(40).pth.tar'.format(epoch))
